...
class ChatbotService:
    """Coordinates chatbot message processing independently of the interface."""

    def __init__(
        self,
        memory: SessionMemory | None = None,
        llm_client: Any | None = None,
        expression_tool: ExpressionTool | None = None,
        parser: MathParser | None = None,
        language_detector: LanguageDetector | None = None,
    ) -> None:
        self.memory = memory or SessionMemory()
        self.llm_client = llm_client or self._build_llm_client()
        self.expression_tool = expression_tool or ExpressionTool()
